...
const PostDetails = () => {
	...
	useEffect(() => {
		...
		if(isLoggedIn){
			dispatch(actions.isPostSavedByUser(id, saved => setIsSaved(saved), errors => setBackendErrors(errors)))
		}
					...
					<div className="mt-4">
						...
						{isLoggedIn && user.id !== post.userSummaryDto.id &&
							<button className="btn btn-primary"
								...
								:
								() => dispatch(actions.savePost(id, () => setIsSaved(true), errors => setBackendErrors(errors)))}>
								{isSaved ? 
									<span>
