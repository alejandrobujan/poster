...
INSERT INTO Post(title, description, url, price, creationDate, expirationDate, userId, categoryId) VALUES ('Windows XP', 'Free windows XP license key', 'g2a.com', 0, '2004-05-12 00:00:00', '2004-05-13 00:00:00', 1, 5);
INSERT INTO Coupon(id, code) VALUES (1, 'XPFREE');

INSERT INTO Post(title, description, url, price, creationDate, expirationDate, userId, categoryId) VALUES ('Windows 11', 'Free windows 11 license key', 'g2a.com' , 0, '2023-05-12 00:00:00', '2024-05-12 00:00:00', 1, 5);
INSERT INTO Offer(id) VALUES (2);

INSERT INTO Post(title, description, url, price, creationDate, expirationDate, userId, categoryId) VALUES ('MG4 Brighton', 'Discover the future of mobility', 'www.mgmotor.eu/es-ES/configurator/mg4', 30480, '2023-10-09 00:00:00', '2024-05-12 00:00:00', 1, 2);
